...
class C2State:
    ...
    def connect_msf(self):
        ...
        try:
            ...
            print(f"[-] msfrpcd -P msf_password -S -a 127.0.0.1")
            self.msf_client = None
            return False
...
# لا نتصل تلقائياً عند البدء - سنتصل عند الحاجة فقط
# سيتم الاتصال أول مرة عند بدء Handler أو طلب Sessions
...
if __name__ == '__main__':
    ...
    print()
    print("⚠️  IMPORTANT: Start Metasploit RPC first:")
    print("    msfrpcd -P msf_password -S -a 127.0.0.1")
    print()
    print("💡 Dashboard will connect to Metasploit when you start the Handler")
    print()
